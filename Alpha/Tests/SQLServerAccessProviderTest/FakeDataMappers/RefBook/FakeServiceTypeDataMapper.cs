...
{
    public class FakeServiceTypeDataMapper : BaseFakeDataMapper
    {
        ...
        {
            return Db.ServiceTypes.ContainsKey(_id) ? Db.ServiceTypes[_id] : null;
        }
        ...
        {
            return Db.ServiceTypes.ContainsKey(_obj.ID);
        }
        ...
        {
            return domainType == typeof(ServiceType);
        }
