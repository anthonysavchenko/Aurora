...
{
    public class FakeIntermediaryDataMapper : BaseFakeDataMapper
    {
        ...
        {
            return Db.Intermediaries.ContainsKey(_id) ? Db.Intermediaries[_id] : null;
        }
        ...
        {
            return Db.Intermediaries.ContainsKey(_obj.ID);
        }
        ...
        {
            return domainType == typeof(Intermediary);
        }
