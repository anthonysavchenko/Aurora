...
{
    public class FakeServiceDataMapper : BaseFakeDataMapper
    {
        ...
        {
            return Db.Services.ContainsKey(_id) ? Db.Services[_id] : null;
        }
        ...
        {
            return Db.Services.ContainsKey(_obj.ID);
        }
        ...
        {
            return domainType == typeof(Service);
        }
