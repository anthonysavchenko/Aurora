...
{
    public class FakePaymentCorrectionDataMapper : BaseFakeDataMapper
    {
        ...
        {
            return Db.PaymentCorrections.ContainsKey(_id) ? Db.PaymentCorrections[_id] : null;
        }
        ...
        {
            return Db.PaymentCorrections.ContainsKey(_obj.ID);
        }
        ...
        {
            return domainType == typeof(PaymentCorrection);
        }
