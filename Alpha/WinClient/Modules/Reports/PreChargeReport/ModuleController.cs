using Taumis.Alpha.WinClient.Aurora.Modules.Reports.PreChargeReport.Constants;
using Taumis.Alpha.WinClient.Aurora.Modules.Reports.PreChargeReport.Views.Layout;
using Taumis.Alpha.WinClient.Aurora.Modules.Reports.PreChargeReport.Views.List;
...
namespace Taumis.Alpha.WinClient.Aurora.Modules.Reports.PreChargeReport
{
    /// <summary>
    /// Контроллер прецедента
    /// </summary>
    [UsecaseName(ApplicationUsecaseNames.PRE_CHARGE_REPORT)]
