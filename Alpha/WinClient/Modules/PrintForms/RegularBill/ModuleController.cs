...
using Taumis.Alpha.WinClient.Aurora.Modules.PrintForms.RegularBill.Views.Layout;
using Taumis.Alpha.WinClient.Aurora.Modules.PrintForms.RegularBill.Views.Report;
...
namespace Taumis.Alpha.WinClient.Aurora.Modules.PrintForms.RegularBill
{
    /// <summary>
    /// Контроллер прецедента
    /// </summary>
    [UsecaseName(ApplicationUsecaseNames.REGULAR_BILL)]
