...
using Taumis.Alpha.WinClient.Aurora.Modules.PrintForms.DebtBill.Views.Layout;
using Taumis.Alpha.WinClient.Aurora.Modules.PrintForms.DebtBill.Views.Report;
...
namespace Taumis.Alpha.WinClient.Aurora.Modules.PrintForms.DebtBill
{
    /// <summary>
    /// Контроллер прецедента
    /// </summary>
    [UsecaseName(ApplicationUsecaseNames.DEBT_BILL)]
