...
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.FillForms.Views.Item;
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.FillForms.Views.Layout;
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.FillForms.Views.List;
...
namespace Taumis.Alpha.WinClient.Aurora.Modules.Uploads.FillForms
{
    /// <summary>
    /// Контроллер модуля
    /// </summary>
    [UsecaseName(ApplicationUsecaseNames.FILL_FORMS)]
