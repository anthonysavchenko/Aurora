...
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.DecFormsUploads.Views.Item;
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.DecFormsUploads.Views.Layout;
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.DecFormsUploads.Views.List;
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.DecFormsUploads.Views.Tabbed;
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.DecFormsUploads.Views.Wizard;
...
namespace Taumis.Alpha.WinClient.Aurora.Modules.Uploads.DecFormsUploads
{
    /// <summary>
    /// Контроллер модуля
    /// </summary>
    [UsecaseName(ApplicationUsecaseNames.DEC_FORMS_UPLOADS)]
