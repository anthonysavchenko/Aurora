...
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.RouteForms.Constants;
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.RouteForms.Views.Item;
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.RouteForms.Views.Layout;
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.RouteForms.Views.List;
using Taumis.Alpha.WinClient.Aurora.Modules.Uploads.RouteForms.Views.Tabbed;
...
namespace Taumis.Alpha.WinClient.Aurora.Modules.Uploads.RouteForms
{
    /// <summary>
    /// Контроллер модуля
    /// </summary>
    [UsecaseName(ApplicationUsecaseNames.ROUTE_FORMS)]
