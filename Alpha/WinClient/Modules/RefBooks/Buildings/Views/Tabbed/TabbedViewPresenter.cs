...
namespace Taumis.Alpha.WinClient.Aurora.Modules.RefBooks.Buildings.Views.Tabbed
{
    public class TabbedViewPresenter : BaseTabbedViewPresenter<IBaseTabbedView, Building>
    {
        /// <summary>
