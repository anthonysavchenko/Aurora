...
using Taumis.Alpha.WinClient.Aurora.Modules.RefBooks.BankDetails.Views.Layout;
using Taumis.Alpha.WinClient.Aurora.Modules.RefBooks.BankDetails.Views.List;
...
namespace Taumis.Alpha.WinClient.Aurora.Modules.RefBooks.BankDetails
{
    [UsecaseName(ApplicationUsecaseNames.BANK_DETAILS)]
