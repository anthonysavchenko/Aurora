CREATE TABLE [dbo].[Buildings] (
    ...
    [CounterValueCollectDistrictID] INT            NULL,
    ...
    CONSTRAINT [FK_Buildings_CounterValueCollectDistricts] FOREIGN KEY ([CounterValueCollectDistrictID]) REFERENCES [dbo].[CounterValueCollectDistricts] ([ID]),
...
GO
CREATE NONCLUSTERED INDEX [IX_CounterValueCollectDistrict]
    ON [dbo].[Buildings]([CounterValueCollectDistrictID] ASC)
    INCLUDE([ID], [Street], [Number]);
